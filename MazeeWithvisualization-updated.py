...
def draw_maze(screen, maze):
    for i, row in enumerate(maze):
        for j, cell in enumerate(row):
            ...
            pygame.draw.rect(screen, '#000000', (j * CELL_SIZE, i * CELL_SIZE, CELL_SIZE, CELL_SIZE), 1)  # Set thickness to 2 for example
...
def draw_start_and_goal(screen, start, goal):
    i, j = start
    pygame.draw.rect(screen, '#FFA500', (j * CELL_SIZE, i * CELL_SIZE, CELL_SIZE, CELL_SIZE))
    text_surface = font.render('S', True, WHITE, '#FFA500')
    screen.blit(text_surface, (j * CELL_SIZE + CELL_SIZE // 3, i * CELL_SIZE + CELL_SIZE // 3))

    i, j = goal
    pygame.draw.rect(screen, '#FFA500', (j * CELL_SIZE, i * CELL_SIZE, CELL_SIZE, CELL_SIZE))
    text_surface = font.render('G', True, WHITE, '#FFA500')
    screen.blit(text_surface, (j * CELL_SIZE + CELL_SIZE // 3, i * CELL_SIZE + CELL_SIZE // 3))
...
visualize_algorithm(screen_dfs, depth_first_search, maze, start, goal, '#808080', GREEN,expanded_nodes_dfs,found_path)

screen_bfs = pygame.display.set_mode((len(maze[0]) * CELL_SIZE, len(maze) * CELL_SIZE))
pygame.display.set_caption("BFS Visualization")
visualize_algorithm(screen_bfs, breadth_first_search, maze, start, goal, '#808080', GREEN,expanded_nodes_bfs,found_path_bfs)


screen_astar = pygame.display.set_mode((len(maze[0]) * CELL_SIZE, len(maze) * CELL_SIZE))
pygame.display.set_caption("A* Visualization")
visualize_algorithm(screen_astar, astar, maze, start, goal, '#808080', GREEN,expanded_nodes_A,found_path_astar)
